...
const divElem = document.querySelector('#link');
...
function moveLeft() {
  imgObj.style.right = parseInt(imgObj.style.right) + 1 + 'px';
...
const fetchPokeData = id => {
  ...
  .then(data => {
    ...
    pic.src = `Emerald Animations/${pokeId.innerText}.gif `
    pokeWeight.textContent = data['weight'];
    pokeHeight.textContent = data['height'];
    pokeFrontImage.src = data['sprites']['front_default'] || '';
    pokeBackImage.src = data['sprites']['back_default'] || '';
    console.log(pokeId.innerText)
  });
};
